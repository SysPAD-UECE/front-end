        ...
        <q-card-section>
          <div class="q-pt-lg">
            <div class="col text-h6 ellipsis flex justify-center">
              <h2 class="text-h3 text-uppercase q-my-none text-weight-regular">Change Password</h2>
            </div>
          </div>
        </q-card-section>
        <q-card-section>
          <q-form class="q-gutter-md" @submit.prevent="submitNewPassword">
            <q-input label="New Password" :type="isPwd ? 'password' : 'text'" v-model="password.newPassowrd" :rules="[
            ...
            <div>
              <q-btn class="full-width" color="primary" label="Send New Password" type="submit" rounded></q-btn>
